...
\label{join_8h_source}\index{/Users/dabowang/doris/be/src/gutil/strings/join.h@{/Users/dabowang/doris/be/src/gutil/strings/join.h}}
...
\DoxyCodeLine{00155\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a73fa83dc96512fae5f0c43fd872161f8}{JoinStrings}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ delim,\ \textcolor{keywordtype}{string}*\ result)\ \{}
...
\DoxyCodeLine{00160\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a73fa83dc96512fae5f0c43fd872161f8}{JoinStrings}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ delim)\ \{}
...
\DoxyCodeLine{00205\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a993c2d7180e5372a42dd3b37cfb4a801}{JoinStringsIterator}}(\textcolor{keyword}{const}\ ITERATOR\&\ start,\ \textcolor{keyword}{const}\ ITERATOR\&\ end,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ delim)\ \{}
\DoxyCodeLine{00206\ \ \ \ \ \textcolor{keywordtype}{string}\ result;}
\DoxyCodeLine{00207\ \ \ \ \ \mbox{\hyperlink{join_8h_a993c2d7180e5372a42dd3b37cfb4a801}{JoinStringsIterator}}(start,\ end,\ delim,\ \&result);}
\DoxyCodeLine{00208\ \ \ \ \ \textcolor{keywordflow}{return}\ result;}
\DoxyCodeLine{00209\ \}}
\DoxyCodeLine{00210\ }
\DoxyCodeLine{00211\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a35517454c5db3b5684a614476993c425}{JoinStringsInArray}}(\textcolor{keywordtype}{string}\ \textcolor{keyword}{const}*\ \textcolor{keyword}{const}*\ components,\ \textcolor{keywordtype}{int}\ num\_components,}
\DoxyCodeLine{00212\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ delim)\ \{}
\DoxyCodeLine{00213\ \ \ \ \ \textcolor{keywordtype}{string}\ result;}
\DoxyCodeLine{00214\ \ \ \ \ \mbox{\hyperlink{join_8h_a35517454c5db3b5684a614476993c425}{JoinStringsInArray}}(components,\ num\_components,\ delim,\ \&result);}
...
\DoxyCodeLine{00219\ \ \ \ \ \textcolor{keywordtype}{string}\ result;}
\DoxyCodeLine{00220\ \ \ \ \ \mbox{\hyperlink{join_8h_a35517454c5db3b5684a614476993c425}{JoinStringsInArray}}(components,\ num\_components,\ delim,\ \&result);}
\DoxyCodeLine{00221\ \ \ \ \ \textcolor{keywordflow}{return}\ result;}
\DoxyCodeLine{00222\ \}}
\DoxyCodeLine{00223\ }
\DoxyCodeLine{00224\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00225\ \textcolor{comment}{//\ JoinMapKeysAndValues()}}
\DoxyCodeLine{00226\ \textcolor{comment}{//\ JoinHashMapKeysAndValues()}}
\DoxyCodeLine{00227\ \textcolor{comment}{//\ JoinVectorKeysAndValues()}}
\DoxyCodeLine{00228\ \textcolor{comment}{//\ \ \ \ This\ merges\ the\ keys\ and\ values\ of\ a\ string\ -\/>\ string\ map\ or\ pair}}
\DoxyCodeLine{00229\ \textcolor{comment}{//\ \ \ \ of\ strings\ vector,\ with\ one\ delim\ (intra\_delim)\ between\ each\ key}}
\DoxyCodeLine{00230\ \textcolor{comment}{//\ \ \ \ and\ its\ associated\ value\ and\ another\ delim\ (inter\_delim)\ between}}
\DoxyCodeLine{00231\ \textcolor{comment}{//\ \ \ \ each\ key/value\ pair.\ \ The\ result\ is\ returned\ in\ a\ string\ (passed}}
\DoxyCodeLine{00232\ \textcolor{comment}{//\ \ \ \ as\ the\ last\ argument).}}
\DoxyCodeLine{00233\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00234\ }
\DoxyCodeLine{00235\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a7e048bd0cc3476e2a9f8f9f0f9baad46}{JoinMapKeysAndValues}}(\textcolor{keyword}{const}\ map<string,\ string>\&\ components,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ intra\_delim,}
\DoxyCodeLine{00236\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ inter\_delim,\ \textcolor{keywordtype}{string}*\ result);}
\DoxyCodeLine{00237\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a84375d422bfc22733678af3b059ca173}{JoinVectorKeysAndValues}}(\textcolor{keyword}{const}\ vector<pair<string,\ string>>\&\ components,}
\DoxyCodeLine{00238\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ intra\_delim,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ inter\_delim,}
\DoxyCodeLine{00239\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{string}*\ result);}
\DoxyCodeLine{00240\ }
\DoxyCodeLine{00241\ \textcolor{comment}{//\ DEPRECATED(jyrki):\ use\ JoinKeysAndValuesIterator\ directly.}}
\DoxyCodeLine{00242\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00243\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a6be131ba61c8bdfe6cd884b3c33aca03}{JoinHashMapKeysAndValues}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{exp_8c_a0acb682b8260ab1c60b918599864e2e5}{T}}\&\ container,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ intra\_delim,}
\DoxyCodeLine{00244\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\&\ inter\_delim,\ \textcolor{keywordtype}{string}*\ result)\ \{}
\DoxyCodeLine{00245\ \ \ \ \ \mbox{\hyperlink{join_8h_ab0cfda3e26f490db12ec8ca56849ef30}{JoinKeysAndValuesIterator}}(container.begin(),\ container.end(),\ intra\_delim,\ inter\_delim,\ result);}
\DoxyCodeLine{00246\ \}}
\DoxyCodeLine{00247\ }
\DoxyCodeLine{00248\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00249\ \textcolor{comment}{//\ JoinCSVLineWithDelimiter()}}
\DoxyCodeLine{00250\ \textcolor{comment}{//\ \ \ \ This\ function\ is\ the\ inverse\ of\ SplitCSVLineWithDelimiter()\ in\ that\ the}}
\DoxyCodeLine{00251\ \textcolor{comment}{//\ \ \ \ string\ returned\ by\ JoinCSVLineWithDelimiter()\ can\ be\ passed\ to}}
\DoxyCodeLine{00252\ \textcolor{comment}{//\ \ \ \ SplitCSVLineWithDelimiter()\ to\ get\ the\ original\ string\ vector\ back.}}
\DoxyCodeLine{00253\ \textcolor{comment}{//\ \ \ \ Quotes\ and\ escapes\ the\ elements\ of\ original\_cols\ according\ to\ CSV\ quoting}}
\DoxyCodeLine{00254\ \textcolor{comment}{//\ \ \ \ rules,\ and\ the\ joins\ the\ escaped\ quoted\ strings\ with\ commas\ using}}
\DoxyCodeLine{00255\ \textcolor{comment}{//\ \ \ \ JoinStrings().\ \ Note\ that\ JoinCSVLineWithDelimiter()\ will\ not\ necessarily}}
\DoxyCodeLine{00256\ \textcolor{comment}{//\ \ \ \ return\ the\ same\ string\ originally\ passed\ in\ to}}
\DoxyCodeLine{00257\ \textcolor{comment}{//\ \ \ \ SplitCSVLineWithDelimiter(),\ since\ SplitCSVLineWithDelimiter()\ can\ handle}}
\DoxyCodeLine{00258\ \textcolor{comment}{//\ \ \ \ gratuitous\ spacing\ and\ quoting.\ 'output'\ must\ point\ to\ an\ empty\ string.}}
\DoxyCodeLine{00259\ \textcolor{comment}{//}}
\DoxyCodeLine{00260\ \textcolor{comment}{//\ \ \ \ Example:}}
\DoxyCodeLine{00261\ \textcolor{comment}{//\ \ \ \ \ [Google],\ [x],\ [Buchheit,\ Paul],\ [string\ with\ "{}\ quoite\ in\ it],\ [\ space\ ]}}
\DoxyCodeLine{00262\ \textcolor{comment}{//\ \ \ \ \ -\/-\/-\/>\ \ [Google,x,"{}Buchheit,\ Paul"{},"{}string\ with\ "{}"{}\ quote\ in\ it"{},"{}\ space\ "{}]}}
\DoxyCodeLine{00263\ \textcolor{comment}{//}}
\DoxyCodeLine{00264\ \textcolor{comment}{//\ JoinCSVLine()}}
\DoxyCodeLine{00265\ \textcolor{comment}{//\ \ \ \ A\ convenience\ wrapper\ around\ JoinCSVLineWithDelimiter\ which\ uses}}
\DoxyCodeLine{00266\ \textcolor{comment}{//\ \ \ \ ','\ as\ the\ delimiter.}}
\DoxyCodeLine{00267\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00268\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a0422dcfbe1f58a9ace659411b6443ff5}{JoinCSVLine}}(\textcolor{keyword}{const}\ vector<string>\&\ original\_cols,\ \textcolor{keywordtype}{string}*\ output);}
\DoxyCodeLine{00269\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a0422dcfbe1f58a9ace659411b6443ff5}{JoinCSVLine}}(\textcolor{keyword}{const}\ vector<string>\&\ original\_cols);}
\DoxyCodeLine{00270\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a6ae60be1ae60603763fc9c535b945838}{JoinCSVLineWithDelimiter}}(\textcolor{keyword}{const}\ vector<string>\&\ original\_cols,\ \textcolor{keywordtype}{char}\ delimiter,\ \textcolor{keywordtype}{string}*\ output);}
\DoxyCodeLine{00271\ }
\DoxyCodeLine{00272\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00273\ \textcolor{comment}{//\ JoinElements()}}
\DoxyCodeLine{00274\ \textcolor{comment}{//\ \ \ \ This\ merges\ a\ container\ of\ any\ type\ supported\ by\ StrAppend()\ with\ delim}}
\DoxyCodeLine{00275\ \textcolor{comment}{//\ \ \ \ inserted\ as\ separators\ between\ components.\ \ This\ is\ essentially\ a}}
\DoxyCodeLine{00276\ \textcolor{comment}{//\ \ \ \ templatize\ version\ of\ JoinUsingToBuffer().}}
\DoxyCodeLine{00277\ \textcolor{comment}{//}}
\DoxyCodeLine{00278\ \textcolor{comment}{//\ JoinElementsIterator()}}
\DoxyCodeLine{00279\ \textcolor{comment}{//\ \ \ \ Same\ as\ JoinElements(),\ except\ that\ the\ input\ elements\ are\ specified}}
\DoxyCodeLine{00280\ \textcolor{comment}{//\ \ \ \ with\ a\ pair\ of\ forward\ iterators.}}
\DoxyCodeLine{00281\ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00282\ }
\DoxyCodeLine{00283\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ ITERATOR>}
\DoxyCodeLine{00284\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a5ef86fe3cd642d776785923f3019e968}{JoinElementsIterator}}(ITERATOR\ first,\ ITERATOR\ last,\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\ delim,\ \textcolor{keywordtype}{string}*\ result)\ \{}
\DoxyCodeLine{00285\ \ \ \ \ result-\/>clear();}
\DoxyCodeLine{00286\ \ \ \ \ \textcolor{keywordflow}{for}\ (ITERATOR\ it\ =\ first;\ it\ !=\ last;\ ++it)\ \{}
\DoxyCodeLine{00287\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (it\ !=\ first)\ \{}
\DoxyCodeLine{00288\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{strcat_8cc_a75606f847a905d124450cda67eba55a9}{StrAppend}}(result,\ delim);}
\DoxyCodeLine{00289\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00290\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{strcat_8cc_a75606f847a905d124450cda67eba55a9}{StrAppend}}(result,\ *it);}
\DoxyCodeLine{00291\ \ \ \ \ \}}
\DoxyCodeLine{00292\ \}}
\DoxyCodeLine{00293\ }
\DoxyCodeLine{00294\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ ITERATOR>}
\DoxyCodeLine{00295\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a5ef86fe3cd642d776785923f3019e968}{JoinElementsIterator}}(ITERATOR\ first,\ ITERATOR\ last,\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\ delim)\ \{}
\DoxyCodeLine{00296\ \ \ \ \ \textcolor{keywordtype}{string}\ result;}
\DoxyCodeLine{00297\ \ \ \ \ \mbox{\hyperlink{join_8h_a5ef86fe3cd642d776785923f3019e968}{JoinElementsIterator}}(first,\ last,\ delim,\ \&result);}
\DoxyCodeLine{00298\ \ \ \ \ \textcolor{keywordflow}{return}\ result;}
\DoxyCodeLine{00299\ \}}
\DoxyCodeLine{00300\ }
\DoxyCodeLine{00301\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ CONTAINER>}
\DoxyCodeLine{00302\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a22204f01948b33487c6c592fd9de6e5f}{JoinElements}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\ delim,\ \textcolor{keywordtype}{string}*\ result)\ \{}
\DoxyCodeLine{00303\ \ \ \ \ \mbox{\hyperlink{join_8h_a5ef86fe3cd642d776785923f3019e968}{JoinElementsIterator}}(components.begin(),\ components.end(),\ delim,\ result);}
\DoxyCodeLine{00304\ \}}
\DoxyCodeLine{00305\ }
\DoxyCodeLine{00306\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ CONTAINER>}
\DoxyCodeLine{00307\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a22204f01948b33487c6c592fd9de6e5f}{JoinElements}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \mbox{\hyperlink{class_string_piece}{StringPiece}}\ delim)\ \{}
\DoxyCodeLine{00308\ \ \ \ \ \textcolor{keywordtype}{string}\ result;}
\DoxyCodeLine{00309\ \ \ \ \ \mbox{\hyperlink{join_8h_a22204f01948b33487c6c592fd9de6e5f}{JoinElements}}(components,\ delim,\ \&result);}
\DoxyCodeLine{00310\ \ \ \ \ \textcolor{keywordflow}{return}\ result;}
\DoxyCodeLine{00311\ \}}
\DoxyCodeLine{00312\ }
\DoxyCodeLine{00313\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ CONTAINER>}
\DoxyCodeLine{00314\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{join_8h_a45b51441d8c9cef238b055357b996e5a}{JoinInts}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ delim,\ \textcolor{keywordtype}{string}*\ result)\ \{}
\DoxyCodeLine{00315\ \ \ \ \ \mbox{\hyperlink{join_8h_a22204f01948b33487c6c592fd9de6e5f}{JoinElements}}(components,\ delim,\ result);}
\DoxyCodeLine{00316\ \}}
\DoxyCodeLine{00317\ }
\DoxyCodeLine{00318\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ CONTAINER>}
\DoxyCodeLine{00319\ \textcolor{keywordtype}{string}\ \mbox{\hyperlink{join_8h_a45b51441d8c9cef238b055357b996e5a}{JoinInts}}(\textcolor{keyword}{const}\ CONTAINER\&\ components,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ delim)\ \{}
\DoxyCodeLine{00320\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{join_8h_a22204f01948b33487c6c592fd9de6e5f}{JoinElements}}(components,\ delim);}
\DoxyCodeLine{00321\ \}}
