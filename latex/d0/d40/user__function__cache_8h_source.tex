...
\label{user__function__cache_8h_source}\index{/Users/dabowang/doris/be/src/runtime/user\_function\_cache.h@{/Users/dabowang/doris/be/src/runtime/user\_function\_cache.h}}
...
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{file__header_8h_aa482bc33779a87f57ab8efc2c1680c48}{checksum}},\ \textcolor{keywordtype}{void}**\ fn\_ptr,}
...
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a3688b2df69cb82531ec5499f7da5f15a}{get\_jarpath}}(int64\_t\ fid,\ \textcolor{keyword}{const}\ std::string\&\ url,\ \textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{file__header_8h_aa482bc33779a87f57ab8efc2c1680c48}{checksum}},}
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::string*\ libpath);}
\DoxyCodeLine{00072\ }
\DoxyCodeLine{00073\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00074\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a1e8d11b01591fc5cc6f2948485304466}{\_load\_cached\_lib}}();}
\DoxyCodeLine{00075\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_aeb200d488e11fe847b33c4c7ebcdd438}{\_load\_entry\_from\_lib}}(\textcolor{keyword}{const}\ std::string\&\ dir,\ \textcolor{keyword}{const}\ std::string\&\ file);}
\DoxyCodeLine{00076\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a122f2494920b286ebd65f42d6b5dcdff}{\_get\_cache\_entry}}(int64\_t\ fid,\ \textcolor{keyword}{const}\ std::string\&\ url,\ \textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{file__header_8h_aa482bc33779a87f57ab8efc2c1680c48}{checksum}},}
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structdoris_1_1_user_function_cache_entry}{UserFunctionCacheEntry}}**\ output\_entry,\ \mbox{\hyperlink{namespacedoris_a6bd8133fc17124d3215b7fc6edecf616}{LibType}}\ type);}
\DoxyCodeLine{00078\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a00f95fe24424e62760a82d96efcc24a9}{\_load\_cache\_entry}}(\textcolor{keyword}{const}\ std::string\&\ url,\ \mbox{\hyperlink{structdoris_1_1_user_function_cache_entry}{UserFunctionCacheEntry}}*\ entry);}
\DoxyCodeLine{00079\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a990ee32ae9bf581f8325833b546b8f9a}{\_download\_lib}}(\textcolor{keyword}{const}\ std::string\&\ url,\ \mbox{\hyperlink{structdoris_1_1_user_function_cache_entry}{UserFunctionCacheEntry}}*\ entry);}
\DoxyCodeLine{00080\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a372425b5cc59bf8e9f7889d9fe8ccf3c}{\_load\_cache\_entry\_internal}}(\mbox{\hyperlink{structdoris_1_1_user_function_cache_entry}{UserFunctionCacheEntry}}*\ entry);}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00082\ \ \ \ \ std::string\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a1f2c1f415310eb7f418b8594d12d75f5}{\_make\_lib\_file}}(int64\_t\ function\_id,\ \textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{file__header_8h_aa482bc33779a87f57ab8efc2c1680c48}{checksum}},\ \mbox{\hyperlink{namespacedoris_a6bd8133fc17124d3215b7fc6edecf616}{LibType}}\ type,}
\DoxyCodeLine{00083\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ file\_name);}
...
\DoxyCodeLine{00087\ \ \ \ \ std::string\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a70f6755cb80afb02ff0cdad19510ae87}{\_get\_file\_name\_from\_url}}(\textcolor{keyword}{const}\ std::string\&\ url)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00089\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00090\ \ \ \ \ std::string\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a63be99a78b3d636df240e1ebd4e6e790}{\_lib\_dir}};}
\DoxyCodeLine{00091\ \ \ \ \ \textcolor{keywordtype}{void}*\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_aa2d0862638e8afa69b76a97612e3fbd9}{\_current\_process\_handle}}\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00092\ }
\DoxyCodeLine{00093\ \ \ \ \ std::mutex\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_adacdb13af3eaf8b74b6913af8fecc8e5}{\_cache\_lock}};}
\DoxyCodeLine{00094\ \ \ \ \ std::unordered\_map<int64\_t,\ UserFunctionCacheEntry*>\ \mbox{\hyperlink{classdoris_1_1_user_function_cache_a6ebf5c34abea3d41879c5bfbb32fa3bc}{\_entry\_map}};}
\DoxyCodeLine{00095\ \};}
\DoxyCodeLine{00096\ }
