...
\item 
void \mbox{\hyperlink{class_allocator_a8e08404b2e8bf6a8e9720622eec19e64}{sys\+\_\+memory\+\_\+check}} (size\+\_\+t size)
\item 
...
\index{Allocator$<$ clear\_memory\_, mmap\_populate $>$@{Allocator$<$ clear\_memory\_, mmap\_populate $>$}!sys\_memory\_check@{sys\_memory\_check}}
\index{sys\_memory\_check@{sys\_memory\_check}!Allocator$<$ clear\_memory\_, mmap\_populate $>$@{Allocator$<$ clear\_memory\_, mmap\_populate $>$}}
\doxysubsubsection{\texorpdfstring{sys\_memory\_check()}{sys\_memory\_check()}}
{\footnotesize\ttfamily void sys\+\_\+memory\+\_\+check (\begin{DoxyParamCaption}\item[{size\+\_\+t}]{size }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
