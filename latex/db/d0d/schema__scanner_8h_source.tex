...
\label{schema__scanner_8h_source}\index{/Users/dabowang/be\_all/exec/schema\_scanner.h@{/Users/dabowang/be\_all/exec/schema\_scanner.h}}
...
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{mem__pool_8h}{runtime/mem\_pool.h}}"{}}}
...
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keyword}{const}\ std::vector<TSchemaTableStructure>*\ \mbox{\hyperlink{structdoris_1_1_schema_scanner_param_a2b571506ef7bdf9293f52eb66033f965}{table\_structure}};}
\DoxyCodeLine{00051\ \ \ \ \ \textcolor{keyword}{const}\ std::string*\ \mbox{\hyperlink{structdoris_1_1_schema_scanner_param_a8402498278d6d11357a82dd2d56be710}{catalog}};}
\DoxyCodeLine{00052\ }
...
\DoxyCodeLine{00089\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classdoris_1_1_tuple_descriptor}{TupleDescriptor}}*\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a020557c08ef1dcb6bc7fa8bdb1800952}{tuple\_desc}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_aa8ef43af19ce6ea0931547d1876de7fa}{\_tuple\_desc}};\ \}}
\DoxyCodeLine{00090\ \ \ \ \ TSchemaTableType::type\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_adbfbed670161297b7269a5e3a7e6c00b}{type}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a76b94214ec85980354eabd4edc5505ee}{\_schema\_table\_type}};\ \}}
\DoxyCodeLine{00091\ }
...
\DoxyCodeLine{00095\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a811728dad108e4e65e19ead5b2b5f2ff}{fill\_dest\_column}}(\mbox{\hyperlink{classdoris_1_1vectorized_1_1_block}{vectorized::Block}}*\ block,\ \textcolor{keywordtype}{void}*\ \mbox{\hyperlink{uint24_8h_aa99be7b8b4274b2256b394ea7bf80762}{data}},\ \textcolor{keyword}{const}\ ColumnDesc\&\ slot\_desc);}
\DoxyCodeLine{00096\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_status}{Status}}\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_acd49d6d400c7a435544b11bc96588d19}{create\_tuple\_desc}}(\mbox{\hyperlink{classdoris_1_1_object_pool}{ObjectPool}}*\ pool);}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00098\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a9542b3368055eb7fb0bf36fc2deea1f3}{\_is\_init}};}
\DoxyCodeLine{00099\ \ \ \ \ \textcolor{comment}{//\ this\ is\ used\ for\ sub\ class}}
\DoxyCodeLine{00100\ \ \ \ \ \mbox{\hyperlink{structdoris_1_1_schema_scanner_param}{SchemaScannerParam}}*\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a43c089605a649b8bf70f8a7fcb6022e2}{\_param}};}
\DoxyCodeLine{00101\ \ \ \ \ \textcolor{comment}{//\ schema\ table's\ column\ desc}}
\DoxyCodeLine{00102\ \ \ \ \ std::vector<ColumnDesc>\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a8182d2e04cee66e838a69bf47fdbfdb3}{\_columns}};}
\DoxyCodeLine{00103\ \ \ \ \ \mbox{\hyperlink{classdoris_1_1_tuple_descriptor}{TupleDescriptor}}*\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_aa8ef43af19ce6ea0931547d1876de7fa}{\_tuple\_desc}};}
\DoxyCodeLine{00104\ }
\DoxyCodeLine{00105\ \ \ \ \ \textcolor{keyword}{static}\ DorisServer*\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a6a06293f6dc781e8bdbb186840df3eb8}{\_s\_doris\_server}};}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00107\ \ \ \ \ TSchemaTableType::type\ \mbox{\hyperlink{classdoris_1_1_schema_scanner_a76b94214ec85980354eabd4edc5505ee}{\_schema\_table\_type}};}
\DoxyCodeLine{00108\ \};}
\DoxyCodeLine{00109\ }
