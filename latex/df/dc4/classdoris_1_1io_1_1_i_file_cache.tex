...
\index{IFileCache@{IFileCache}!get\_version\_path@{get\_version\_path}}
\index{get\_version\_path@{get\_version\_path}!IFileCache@{IFileCache}}
\doxysubsubsection{\texorpdfstring{get\_version\_path()}{get\_version\_path()}}
{\footnotesize\ttfamily std\+::string get\+\_\+version\+\_\+path (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const}
...
\begin{center}
\leavevmode
\includegraphics[width=319pt]{df/dc4/classdoris_1_1io_1_1_i_file_cache_a9080d155c7a2120f589d67c58a0a9a07_icgraph}
\end{center}
\end{figure}
...
\index{IFileCache@{IFileCache}!USE\_CACHE\_VERSION2@{USE\_CACHE\_VERSION2}}
\index{USE\_CACHE\_VERSION2@{USE\_CACHE\_VERSION2}!IFileCache@{IFileCache}}
\doxysubsubsection{\texorpdfstring{USE\_CACHE\_VERSION2}{USE\_CACHE\_VERSION2}}
{\footnotesize\ttfamily constexpr bool USE\+\_\+\+CACHE\+\_\+\+VERSION2 = true\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [constexpr]}}
...
\index{IFileCache@{IFileCache}!KEY\_PREFIX\_LENGTH@{KEY\_PREFIX\_LENGTH}}
\index{KEY\_PREFIX\_LENGTH@{KEY\_PREFIX\_LENGTH}!IFileCache@{IFileCache}}
\doxysubsubsection{\texorpdfstring{KEY\_PREFIX\_LENGTH}{KEY\_PREFIX\_LENGTH}}
{\footnotesize\ttfamily constexpr int KEY\+\_\+\+PREFIX\+\_\+\+LENGTH = 3\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [constexpr]}}
