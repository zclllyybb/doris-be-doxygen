...
\label{util_2simd_2bits_8h_source}\index{/Users/dabowang/doris/be/src/util/simd/bits.h@{/Users/dabowang/doris/be/src/util/simd/bits.h}}
...
\DoxyCodeLine{00104\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{namespacedoris_1_1simd_a2037a2a65b853aa795118513d77f9e12}{find\_byte}}(\textcolor{keyword}{const}\ std::vector<T>\&\ vec,\ \textcolor{keywordtype}{size\_t}\ start,\ \mbox{\hyperlink{exp_8c_a0acb682b8260ab1c60b918599864e2e5}{T}}\ \textcolor{keywordtype}{byte})\ \{}
\DoxyCodeLine{00105\ \ \ \ \ \textcolor{keywordflow}{if}\ (start\ >=\ vec.size())\ \{}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ start;}
\DoxyCodeLine{00107\ \ \ \ \ \}}
\DoxyCodeLine{00108\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ p\ =\ std::memchr((\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*)(vec.data()\ +\ start),\ \textcolor{keywordtype}{byte},\ vec.size()\ -\/\ start);}
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keywordflow}{if}\ (p\ ==\ \textcolor{keyword}{nullptr})\ \{}
\DoxyCodeLine{00110\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ vec.size();}
\DoxyCodeLine{00111\ \ \ \ \ \}}
\DoxyCodeLine{00112\ \ \ \ \ \textcolor{keywordflow}{return}\ (\mbox{\hyperlink{exp_8c_a0acb682b8260ab1c60b918599864e2e5}{T}}*)p\ -\/\ vec.data();}
\DoxyCodeLine{00113\ \}}
\DoxyCodeLine{00114\ }
...
\DoxyCodeLine{00118\ \}}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00120\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{namespacedoris_1_1simd_a820c97bed2ac08e6adf23ea625118e1b}{find\_one}}(\textcolor{keyword}{const}\ std::vector<uint8\_t>\&\ vec,\ \textcolor{keywordtype}{size\_t}\ start)\ \{}
\DoxyCodeLine{00121\ \ \ \ \ \textcolor{keywordflow}{return}\ find\_byte<uint8\_t>(vec,\ start,\ 1);}
\DoxyCodeLine{00122\ \}}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{namespacedoris_1_1simd_a96a0285bb88cd14e78068db1599e9fd3}{find\_zero}}(\textcolor{keyword}{const}\ std::vector<uint8\_t>\&\ vec,\ \textcolor{keywordtype}{size\_t}\ start)\ \{}
\DoxyCodeLine{00125\ \ \ \ \ \textcolor{keywordflow}{return}\ find\_byte<uint8\_t>(vec,\ start,\ 0);}
\DoxyCodeLine{00126\ \}}
\DoxyCodeLine{00127\ }
